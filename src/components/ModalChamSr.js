...
class ModalExample extends React.Component {
  ...
  render() {
    return (
      <div style={{ marginLeft: "335px", marginBottom: "55px" }}>
        <h2 style={{ fontSize: "5px", fontWeight: "bold", marginLeft: "-5px" }}>
          ...
          <ModalBody>
            <Row>
              ...
              <Col>
                ...
                <br />
                <strong>7g</strong> un juste milieu pour les amateurs cherchant
                de nouvelles sansations
                <br />
